...
{{< blank_link link="https://github.com/Hugolify/hugolify-admin/tree/v0.9/layouts/partials/admin/cms/decapcms/shortcodes" text="See examples in repository (for decap CMS)" >}}
