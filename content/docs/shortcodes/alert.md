...
- {{< blank_link link="https://github.com/Hugolify/hugolify-admin/blob/main/layouts/partials/admin/shortcodes/fields/alert.html" text="Shortcode fields file — hugolify-admin" >}}
